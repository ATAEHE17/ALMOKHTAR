...
var MC_DICT = {
  ar: {
    ...
    confirmTitle: 'تأكيد', confirmDeleteBtn: 'تأكيد الحذف', sendAbsenceMessagesTitle: 'إرسال رسائل الغياب',
    absenceQueueHint: 'دوس "إرسال" جنب كل طالب لوحده. هيفتح واتساب برسالته جاهزة، ابعتها وارجع تاني هنا للطالب اللي بعده.',
  ...
  en: {
    ...
    confirmTitle: 'Confirm', confirmDeleteBtn: 'Confirm delete', sendAbsenceMessagesTitle: 'Send absence messages',
    absenceQueueHint: 'Tap "Send" next to each student one at a time. WhatsApp opens with the message ready — send it, then come back here for the next student.',
